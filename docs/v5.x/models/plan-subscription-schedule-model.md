...
There are some things different to  [Laravel LaraSub Schedule](https://github.com/ljsharp/larasub-schedule). In the
...
use Ljsharp\LaraSub\Traits\IsScheduleService;
